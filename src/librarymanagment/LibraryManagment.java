...
public class LibraryManagment extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LibraryManagment
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        admin.AdminLogin x = null;
        try {
            x = new admin.AdminLogin();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(LibraryManagment.class.getName()).log(Level.SEVERE, null, ex);
        }
        x.setVisible(true);
        this.hide();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
       librarian.LibrarianLogin x = null;
        try {
            x = new librarian.LibrarianLogin();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(LibraryManagment.class.getName()).log(Level.SEVERE, null, ex);
        }
        x.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
          student.StudentLogin x = null;
        try {
            x = new  student.StudentLogin();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(LibraryManagment.class.getName()).log(Level.SEVERE, null, ex);
        }
           this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibraryManagment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
